...
> **ПРЕДУПРЕЖДЕНИЕ: Несанкционированное распространение музыки, защищённой авторским правом, незаконно.**
> Этот инструмент предназначен только для личного использования. Запрещается делиться, распространять или публиковать загруженный контент. Уважайте артистов и авторское право.
